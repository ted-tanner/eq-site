...
const DATABASE_URL_VAR: &str = "EQSITE_DATABASE_URL";
const DB_MAX_CONNECTIONS_VAR: &str = "EQSITE_DB_MAX_CONNECTIONS";
const COOKIE_SIGNING_KEY_VAR: &str = "EQSITE_COOKIE_SIGNING_KEY_B64";
const PASSWORD_PEPPER_VAR: &str = "EQSITE_PASSWORD_PEPPER_B64";
const PASSWORD_HASH_LENGTH_VAR: &str = "EQSITE_PASSWORD_HASH_LENGTH";
const PASSWORD_HASH_ITERATIONS_VAR: &str = "EQSITE_PASSWORD_HASH_ITERATIONS";
const PASSWORD_HASH_MEM_COST_KIB_VAR: &str = "EQSITE_PASSWORD_HASH_MEM_COST_KIB";
const PASSWORD_HASH_THREADS_VAR: &str = "EQSITE_PASSWORD_HASH_THREADS";
const ACCESS_TOKEN_LIFETIME_MINS_VAR: &str = "EQSITE_ACCESS_TOKEN_LIFETIME_MINS";
const SIGNIN_TOKEN_LIFETIME_MINS_VAR: &str = "EQSITE_SIGNIN_TOKEN_LIFETIME_MINS";
const REFRESH_TOKEN_LIFETIME_DAYS_VAR: &str = "EQSITE_REFRESH_TOKEN_LIFETIME_DAYS";
const SECURE_COOKIES_VAR: &str = "EQSITE_SECURE_COOKIES";
const BOOTSTRAP_ADMIN_EMAIL_VAR: &str = "EQSITE_BOOTSTRAP_ADMIN_EMAIL";
const TEMP_PASSWORD_LENGTH_VAR: &str = "EQSITE_TEMP_PASSWORD_LENGTH";
const RUN_BACKGROUND_TASKS_VAR: &str = "EQSITE_RUN_BACKGROUND_TASKS";
const BLACKLIST_CLEANUP_JOB_FREQUENCY_SECS_VAR: &str =
    "EQSITE_BLACKLIST_CLEANUP_JOB_FREQUENCY_SECS";
const BIND_HOST_VAR: &str = "EQSITE_BIND_HOST";
const PORT_VAR: &str = "EQSITE_PORT";
const ACTIX_WORKER_COUNT_VAR: &str = "EQSITE_ACTIX_WORKER_COUNT";
const WEB_PATH_VAR: &str = "EQSITE_WEB_PATH";
const LOG_LEVEL_VAR: &str = "EQSITE_LOG_LEVEL";
const LOG_PATH_VAR: &str = "EQSITE_LOG_PATH";
const MAX_PASSWORD_LENGTH_VAR: &str = "EQSITE_MAX_PASSWORD_LENGTH";
const TLS_CERT_PATH_VAR: &str = "EQSITE_TLS_CERT_PATH";
const TLS_KEY_PATH_VAR: &str = "EQSITE_TLS_KEY_PATH";
const PEER_IP_USE_X_FORWARDED_FOR_VAR: &str = "EQSITE_PEER_IP_USE_X_FORWARDED_FOR";
const RATE_LIMITER_CLEAR_FREQUENCY_HOURS_VAR: &str = "EQSITE_RATE_LIMITER_CLEAR_FREQUENCY_HOURS";
const RATE_LIMITER_WARN_EVERY_OVER_LIMIT_VAR: &str = "EQSITE_RATE_LIMITER_WARN_EVERY_OVER_LIMIT";
const LIGHT_AUTH_FAIR_USE_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_LIGHT_AUTH_FAIR_USE_LIMITER_MAX_PER_PERIOD";
const LIGHT_AUTH_FAIR_USE_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_LIGHT_AUTH_FAIR_USE_LIMITER_PERIOD_SECS";
const HEAVY_AUTH_FAIR_USE_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_HEAVY_AUTH_FAIR_USE_LIMITER_MAX_PER_PERIOD";
const HEAVY_AUTH_FAIR_USE_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_HEAVY_AUTH_FAIR_USE_LIMITER_PERIOD_SECS";
const CREATE_FAIR_USE_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_CREATE_FAIR_USE_LIMITER_MAX_PER_PERIOD";
const CREATE_FAIR_USE_LIMITER_PERIOD_SECS_VAR: &str = "EQSITE_CREATE_FAIR_USE_LIMITER_PERIOD_SECS";
const POST_FAIR_USE_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_POST_FAIR_USE_LIMITER_MAX_PER_PERIOD";
const POST_FAIR_USE_LIMITER_PERIOD_SECS_VAR: &str = "EQSITE_POST_FAIR_USE_LIMITER_PERIOD_SECS";
const SURVEY_RESPONSE_FAIR_USE_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_SURVEY_RESPONSE_FAIR_USE_LIMITER_MAX_PER_PERIOD";
const SURVEY_RESPONSE_FAIR_USE_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_SURVEY_RESPONSE_FAIR_USE_LIMITER_PERIOD_SECS";
const READ_FAIR_USE_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_READ_FAIR_USE_LIMITER_MAX_PER_PERIOD";
const READ_FAIR_USE_LIMITER_PERIOD_SECS_VAR: &str = "EQSITE_READ_FAIR_USE_LIMITER_PERIOD_SECS";
const UPDATE_FAIR_USE_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_UPDATE_FAIR_USE_LIMITER_MAX_PER_PERIOD";
const UPDATE_FAIR_USE_LIMITER_PERIOD_SECS_VAR: &str = "EQSITE_UPDATE_FAIR_USE_LIMITER_PERIOD_SECS";
const DELETE_FAIR_USE_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_DELETE_FAIR_USE_LIMITER_MAX_PER_PERIOD";
const DELETE_FAIR_USE_LIMITER_PERIOD_SECS_VAR: &str = "EQSITE_DELETE_FAIR_USE_LIMITER_PERIOD_SECS";
const LIGHT_AUTH_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_LIGHT_AUTH_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD";
const LIGHT_AUTH_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_LIGHT_AUTH_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS";
const HEAVY_AUTH_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_HEAVY_AUTH_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD";
const HEAVY_AUTH_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_HEAVY_AUTH_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS";
const CREATE_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_CREATE_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD";
const CREATE_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_CREATE_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS";
const READ_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_READ_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD";
const READ_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_READ_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS";
const UPDATE_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_UPDATE_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD";
const UPDATE_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_UPDATE_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS";
const DELETE_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD_VAR: &str =
    "EQSITE_DELETE_CIRCUIT_BREAKER_LIMITER_MAX_PER_PERIOD";
const DELETE_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS_VAR: &str =
    "EQSITE_DELETE_CIRCUIT_BREAKER_LIMITER_PERIOD_SECS";
const CORS_ALLOWED_ORIGINS_VAR: &str = "EQSITE_CORS_ALLOWED_ORIGINS";

const COOKIE_SIGNING_KEY_SIZE: usize = 64;
const PASSWORD_PEPPER_SIZE: usize = 32;
...
pub struct ConfigInner {
    ...
    pub password_pepper: [u8; PASSWORD_PEPPER_SIZE],
    #[zeroize(skip)]
...
impl Config {
    pub fn from_env() -> Result<Self, ConfigError> {
        ...
        let password_pepper = decode_fixed::<PASSWORD_PEPPER_SIZE>(PASSWORD_PEPPER_VAR)?;
        ...
        Ok(Self {
            inner: UnsafeCell::new(ConfigInner {
                database_url: env_var_or(DATABASE_URL_VAR, String::from("eq-site-test.db"))?,
                ...
                web_path: std::env::var(WEB_PATH_VAR)
